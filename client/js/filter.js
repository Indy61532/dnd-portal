...
This filter system is designed to be easily extensible and maintainable.

HOW TO ADD NEW FILTER CATEGORIES:
================================

1. EASY WAY - Use FilterManager:
   FilterManager.addCategory({
       id: 'new_category',
...
2. MANUAL WAY - Edit getFilterCategories() method:
   Add a new object to the array in the getFilterCategories() method:
   {
       id: 'new_category',
       name: 'New Category Name', 
       keywords: ['Keyword1', 'Keyword2'],
...
// Add a new category for "Magic Items"
FilterManager.addCategory({
    id: 'magic_items',
    name: 'Magic Items',
    keywords: ['Magic', 'Enchanted', 'Magical'],
    description: 'Filter for magical items'
});

// Update an existing category
FilterManager.updateCategory('item', {
    name: 'Updated Item',
    keywords: ['Item', 'Weapon', 'Armor']
});

// Remove a category
FilterManager.removeCategory('item');
...
=========================
{
    id: 'unique_identifier',           // Required: Unique ID for the category
    name: 'Display Name',              // Required: Name shown in the filter modal
    keywords: ['Keyword1', 'Keyword2'], // Required: Array of keywords to match against item types
    description: 'Description'         // Optional: Description of the category
}

KEYWORDS MATCHING:
=================
The system matches keywords against the text content of elements with class 'item-type'.
For example, if an item has <span class="item-type">Magic Sword</span>, 
it will match categories with keywords like ['Magic', 'Sword', 'Weapon'].
...
NOTIFICATIONS:
=============
- Shows count of visible items after filtering
